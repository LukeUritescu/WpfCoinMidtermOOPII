...
namespace UnitTestCoin
{
    ...
    public class USCoinTests
    {
        ...
        public void USCoinPennyConstructor()
        {
            ...
            //Assert
            Assert.AreEqual(WpfCoinMidterm.USCoinMintMark.D, p.MintMark); //D is the default mint mark
        ...
        public void USCoinMintMark()
        {
            ...
            D = WpfCoinMidterm.USCoinMintMark.D;
            P = WpfCoinMidterm.USCoinMintMark.P;
            S = WpfCoinMidterm.USCoinMintMark.S;
            W = WpfCoinMidterm.USCoinMintMark.W;
